...
CREATE TABLE `tp_cate`  (
  ...
  `type` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '类别 0系统 1文章',
  `name` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '菜单名称',
  `parent_id` smallint(6) UNSIGNED NOT NULL DEFAULT 0 COMMENT '父级id',
  `icon` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '菜单图标',
  `module` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '模块',
  `controller` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '控制器',
  `action` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '操作',
  `parameter` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '参数',
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态（1正常，2删除，3禁用）',
  `show_place` bit(1) NOT NULL DEFAULT b'0' COMMENT '顶部导航显示位置 0顶部导航 1三个点的地方',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  `sort` smallint(6) UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统所有分类表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tp_cate
-- ----------------------------
INSERT INTO `tp_cate` VALUES (1, 0, '系统菜单', 0, 'icon wb-menu', '0', '0', '0', '0', 1, b'0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
INSERT INTO `tp_cate` VALUES (2, 1, '99', 0, '0', '0', '0', '0', '0', 1, b'0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
INSERT INTO `tp_cate` VALUES (3, 1, '222', 0, '0', '0', '0', '0', '0', 1, b'0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
INSERT INTO `tp_cate` VALUES (4, 1, '0000', 0, '0', '0', '0', '0', '0', 1, b'0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
INSERT INTO `tp_cate` VALUES (5, 1, '99', 0, '0', '0', '0', '0', '0', 1, b'0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
INSERT INTO `tp_cate` VALUES (6, 1, '55', 0, '0', '0', '0', '0', '0', 1, b'0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
INSERT INTO `tp_cate` VALUES (7, 1, '3333', 0, '0', 'cate', 'Detail', 'save', '0', 1, b'0', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
INSERT INTO `tp_cate` VALUES (8, 1, '852', 1, '0', 'cate', 'Detail', 'save', '0', 1, b'0', '2017-10-28 22:15:52', '2017-10-29 12:04:49', 0);
INSERT INTO `tp_cate` VALUES (9, 1, '一二三四', 0, '0', 'cate', 'Detail', 'save', '0', 1, b'0', '2017-10-29 10:17:16', '2017-10-29 12:03:58', 0);
INSERT INTO `tp_cate` VALUES (10, 1, '一二', 9, '0', 'cate', 'Detail', 'save', '0', 1, b'0', '2017-10-29 10:19:13', '2017-10-29 10:19:13', 0);
INSERT INTO `tp_cate` VALUES (11, 1, '一二三', 0, '0', 'cate', 'Detail', 'save', '0', 1, b'0', '2017-10-29 10:21:00', '2017-10-29 22:40:20', 0);
INSERT INTO `tp_cate` VALUES (12, 1, 'oooi', 0, '0', 'cate', 'Detail', 'save', '0', 0, b'0', '2017-10-29 21:10:28', '2017-10-31 21:46:19', 0);
INSERT INTO `tp_cate` VALUES (13, 1, 'bbb', 9, '0', 'cate', 'Detail', 'save', '0', 0, b'0', '2017-10-29 21:17:33', '2017-10-29 21:17:58', 0);
...
CREATE TABLE `tp_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_member`  (
  ...
  `user_name` char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0',
  `pass_word` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `pass_salt` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `token` char(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `house` tinyint(1) NULL DEFAULT 0 COMMENT '具体哪一栋楼或者具体哪一个户型，根据room来区分',
  `gender` tinyint(1) UNSIGNED NOT NULL DEFAULT 1,
  `true_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  ...
  `reg_ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `create_time` datetime(0) NOT NULL DEFAULT '0000-00-00 00:00:00',
  `login_ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `login_time` datetime(0) NOT NULL DEFAULT '0000-00-00 00:00:00',
  `login_times` int(10) UNSIGNED NOT NULL DEFAULT 1,
  `black` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `send` tinyint(1) UNSIGNED NOT NULL DEFAULT 0,
  `auth` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `authvalue` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `auth_time` datetime(0) NOT NULL DEFAULT '0000-00-00 00:00:00',
...
) ENGINE = MyISAM AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '预约登记备注表' ROW_FORMAT = Dynamic;
